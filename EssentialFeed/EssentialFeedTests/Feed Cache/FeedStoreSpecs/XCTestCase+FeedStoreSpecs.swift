...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func assertThatRetrieveDeliversFoundValuesOnNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut: sut, toRetrieve: .success(.some(CachedFeed(feed, timestamp))), file: file, line: line)
    }
    ...
    func assertThatRetrieveHasNoSideEffectsOnNonEmptyCache(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut, toRetrieveTwice: .success(.some(CachedFeed(feed, timestamp))), file: file, line: line)
    }
    ...
    func assertThatInsertOverridesPreviouslyInsertedCacheValues(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        expect(sut: sut, toRetrieve: .success(.some(CachedFeed(latestFeed, latestTimestamp))), file: file, line: line)
    }
    ...
    func assertThatSideEffectsRunSerially(on sut: FeedStore, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.insert(feed: uniqueFeedImage().local, timestamp: Date()) { _ in
    ...
    func insert(_ sut: FeedStore, _ insertedFeed: [LocalFeedImage], _ timestamp: Date) -> Error? {
        ...
        sut.insert(feed: insertedFeed, timestamp: timestamp, completion: { result in
